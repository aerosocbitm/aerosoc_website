...
const AboutUs = () => {
  return (
    <section 
      id="about" 
      // CHANGED: md: to lg: for alignment and padding
    ...
    >
      <div className="w-full lg:w-1/2 flex flex-col justify-start lg:justify-center items-start pointer-events-auto ml-auto pl-0 lg:pl-12">
        ...
        {/* Centered on mobile/tab (text-center lg:text-left) */}
        <h3 className="w-full text-center lg:text-left text-accent font-sans text-sm sm:text-base lg:text-base tracking-[0.3em] uppercase mb-6 sm:mb-8">
          Know About US:
        </h3>
        
        {/* Centered on mobile/tab (text-center lg:text-left) */}
        <p className="w-full text-center lg:text-left text-gray-400 font-sans text-lg sm:text-xl lg:text-xl leading-relaxed mb-5 sm:mb-6">
        ...
        <p className="w-full text-center lg:text-left text-gray-400 font-sans text-lg sm:text-xl lg:text-xl leading-relaxed">
